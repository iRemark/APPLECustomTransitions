...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"+" style:UIBarButtonItemStyleDone target:self action:@selector(buttonAction:)];
    
    //    self.navigationController.navigationBar.hidden = NO;
    //
    //    self.tabBarController.tabBar.frame = CGRectMake(0, 0, kScreenWidth, 44);
